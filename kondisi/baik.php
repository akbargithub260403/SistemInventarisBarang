...
$barang = mysqli_query($conn,"SELECT * FROM barang WHERE kondisi = 1");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg">
											<?php echo"<img src='../function/img/".$_SESSION["gambar"]."'class='avatar-img rounded-circle'>" ?></div>
										<div class="u-text">
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Dengan Kondisi Baik</h4>
										<a style="position: absolute; left: 270px;" href="../Export/exportBaik.php"><button class="btn btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-down"></i></button></a>
