						...
						<li class="nav-item active">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="rusak_sedang.php">
											<span class="sub-item">Rusak Ringan</span>
										</a>
									</li>
									<li>
										<a href="rusak_berat.php">
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Dengan Kondisi Rusak Ringan</h4>
										<a style="position: absolute; left: 340px;" href="../Export/exportSedang.php"><button class="btn btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-down"></i></button></a>
...
function Export(){
	document.proses.action = 'multiple/export.php';
