...
$barang = mysqli_query($conn,"SELECT * FROM barang WHERE kondisi = 3");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Dengan Kondisi Rusak Berat</h4>
										<a style="position: absolute; left: 340px;" href="../Export/exportBerat.php"><button class="btn btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-down"></i></button></a>
