					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm"><?php echo"<img src='function/img/".$_SESSION["gambar"]."'class='avatar-img rounded-circle'>" ?>
								</div>
							</a>
									...
									<div class="row mt-3">
										<div class="col-md-6">
											<div class="form-group form-group-default">
												<label>Name</label>
												<input type="text" class="form-control" value="<?php echo $_SESSION['nama_user']; ?>" name="nama" placeholder="Name">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-group-default">
												<label>Tempat Tinggal / Lahir</label>
												<input type="text" value="<?php echo $_SESSION['ttl']; ?>" class="form-control" name="TTL" placeholder="Name">
											</div>
										</div>
									</div>
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-group-default">
												...
												<input type="text" class="form-control" name="unit_kerja" value="<?php echo $_SESSION['unit_kerja']; ?>">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>NIP / NIPTT</label>
												<input type="text" class="form-control" value="<?php echo $_SESSION['nip']; ?>" name="NIPTT">
											</div>
										</div>
...
<?php echo"<img src='function/img/".$_SESSION["gambar"]."'class='avatar-img rounded-circle'>" ?>
								...
								<div class="card-body">
									<div class="user-profile text-center">
										<div class="name"><?php echo $_SESSION['username_user']; ?></div>
										...
										<div class="view-profile">
											<a href="userprofile.php" class="btn btn-secondary btn-block">View Full Profile</a>
										</div>
									</div>
								</div>
