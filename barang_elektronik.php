...
$barang = mysqli_query($conn,"SELECT * FROM barang WHERE jenis = 1");
 ?>
 <!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Elektronik</h4>
...
function Export(){
	document.proses.action = 'Export/barang_elektronik.php';
	document.proses.submit();
}

</script>

<script type="text/javascript" src="liveSearchEL.js"></script>
