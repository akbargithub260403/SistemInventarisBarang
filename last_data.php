...
$barang = mysqli_query($conn,"SELECT * FROM last_data");

if (isset($_POST['cari'])) {
	
	$barang = cari_last_data($_POST['keyword']);
}
 ?>
 <!DOCTYPE html>
<html lang="en">
...
<body>
			...
			<nav class="navbar navbar-header navbar-expand-lg">
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
									...
									<button onclick="Delete()" class="btn btn-sm btn-danger">
		...
		<div class="sidebar">
			...
			<div class="sidebar-wrapper scrollbar-inner">
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2"><?php echo"<img src='function/img/".$_SESSION["gambar"]."'class='avatar-img rounded-circle'>" ?>
						</div>
						<div class="info">
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Last Data Barang</h4>

								<form style="position: absolute; left: 180px; width: 400px;" action="" method="POST">
									<input type="text" autocomplete="off" name="keyword" placeholder="Cari data....." class="form form-group form-control md-8">	
									<button type="submit" name="cari" hidden="" id="tombol-cari">Cari</button>	
								</form>
	...
	<td><input type="checkbox" name="checked[]" class="check" value="<?php echo $brg['id']; ?>"></td>
	...
	<td>
		...
		<a href="function/delete.php?id=<?php echo $brg['id'];?>"><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Delete">
		<i class="fas fa-trash"></i>
		</div>
	</td>
...
function Delete(){
	...
	if (konfirmasi) {
		document.proses.action = 'multiple/delete.php';
		document.proses.submit();
	}
}
function Export(){
	document.proses.action = 'multiple/export_last_data.php';
	document.proses.submit();
}
