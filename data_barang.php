						...
						<div class="card-header">
							<div class="d-flex align-items-center">
										<h4 class="card-title">Tambah Barang</h4>
											<a href="function/add_barang.php"><button style="position: absolute;right: 10px; top: 10px;" class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addRowModal">
