						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form Data Admin</div>
								</div>
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" name="nama" class="form-control" id="email2" placeholder="Nama">
										
									</div>
		
								<div class="form-group">
										<label for="email2">Tempat Tanggal / Lahir</label>
										<input type="text" name="TTL" class="form-control" autocomplete="" id="email2" placeholder="Tempat Tanggal Lahir">
										
									</div>
								
									
									<div class="form-group">
										<label for="email2">Unit Kerja</label>
										<input type="text" autocomplete="" name="unit_kerja" class="form-control" id="email2" placeholder="Unit Kerja">
										
									</div>
									<div class="form-group">
										<label for="email2">NIP / NIPTT</label>
										<input type="text" name="NIPTT" autocomplete="" class="form-control" id="email2" placeholder="NIP">
										
									</div>

										<div class="form-group">
										<label for="email2">Username</label>
										<input type="text" name="username" autocomplete="" class="form-control" id="email2" placeholder="username">
										
									</div>
										<div class="form-group">
										<label for="email2">Password</label>
										<input type="password" name="password" autocomplete="" class="form-control" id="email2" placeholder="Password">
										
									</div>
									<div class="form-group">
										<label for="email2">Konfirmasi Password</label>
										<input type="password" name="password2" autocomplete="" class="form-control" id="email2" placeholder="Konfirmasi password">
									</div>
									<div class="form-group">
										<label for="email2">Icon Admin</label>
										<input type="file" name="gambar" autocomplete="" class="form-control">
									</div>
